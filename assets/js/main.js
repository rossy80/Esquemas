...
rojo.style.width = "400px";
rojo.style.height = "400px";
rojo.style.padding = "50px";

morado.style.position = "relative";
morado.style.background = "purple";
morado.style.width = "300px";
morado.style.height = "300px";
morado.style.top = "40px";
morado.style.left = "40px";
